...
MediaSegmentInfo.prototype.appendSyncPoint = function (sampleInfo) {  // also called Random Access Point
...
MediaSegmentInfoList.prototype.type = function () {
    return this._type;
}

MediaSegmentInfoList.prototype.length = function () {
