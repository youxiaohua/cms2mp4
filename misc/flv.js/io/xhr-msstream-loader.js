...
function MSStreamLoader(seekHandler, config) {
    ...
    BaseLoader.call(this, 'xhr-msstream-loader');
...
inherites(MSStreamLoader, BaseLoader);
...
MSStreamLoader.prototype._msrOnLoad = function (e) {  // actually it is onComplete event
    this._status = LoaderStatus.kComplete;
    if (this._onComplete) {
